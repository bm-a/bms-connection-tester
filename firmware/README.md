# Ready-to-flash binaries — v2.2 (ESP32-S3 DevKitC-1, 8 MB flash)

Built 2026-09-24 from this exact source (`pio run -e esp32-s3-devkitc-1`,
...
## Verify
- `firmware.bin` (768,048 bytes)
  SHA-256: `acb44424c7ff5aa21014aedf1befcd2e73c870d9455820c8523ee984b32d74e0`
