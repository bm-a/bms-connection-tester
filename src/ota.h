...
// Release asset names (see GitHub Releases: plain + n16r8- triples).
...
// -D strings do not survive the build-flag pipeline). Everything else is 8mb.
#ifdef FW_IS_N16R8
...
// Asset file to download for a variant tag ("8mb" or "n16r8").
